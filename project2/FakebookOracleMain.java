...
public final class FakebookOracleMain {
    // Member Variables
    private static String username = "bxz"; // replace with your uniqname
    private static String password = "eecs484"; // replace with your Oracle password (default: eecsclass)
